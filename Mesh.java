    ...
    private Vector3[] computeNormals () {
        ...
        try {
            for (int i = 0; i < 3 * getNumFaces(); i += 3) {
                ...
                Vector v1 = vertices[faces[i]];
                Vector v2 = vertices[faces[i+1]];
                Vector v3 = vertices[faces[i+2]];

                n1.set(v1.get(0) - v2.get(0), v1.get(1) - v2.get(1), v1.get(2) - v2.get(2));
                n2.set(v1.get(0) - v3.get(0), v1.get(1) - v3.get(1), v1.get(2) - v3.get(2));
